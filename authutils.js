define(['underscore', 'querystring', 'oauth'], function(_, querystring, oauth) {
  authutils = exports = {};

  // For the sake of this test, which is mocking up a client, we're just going to
  // put the contents of CryptoJS's hmac-sha1.js file here. A client would
  ...
  function signRequest(params, options) {
    ...
    switch (params.oauth_signature_method) {
      ...
      case 'HMAC-SHA1':
        ...
        var base = authutils.constructBaseString(
